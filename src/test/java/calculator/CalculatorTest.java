...
class CalculatorTest {
    ...
    @Test
    void subtract() {
        assertEquals(10.299999237060547, Calculator.subtract(19.7F, 30.0F), "there is no match with the expected value" );
    }

    @Test
    void divide() {
        assertEquals(2.0, Calculator.divide(40.0F, 20.0F), "there is no match with the expected value" );
        assertThrows(ArithmeticException.class, () -> Calculator.divide(20.3F, 0.0F), "with division by zero must be an exception");
    }
